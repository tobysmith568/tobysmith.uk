...
After you've built your static artifacts, upload them using the `actions/upload-pages-artifact` Action <Anchor href="https://github.com/tobysmith568/license-cop/blob/b65221df595fc70d25f307047b3bc34a58b724bd/.github/workflows/website.yml#L50" text="like this" />:

```
// TODO
```

Then, as soon as you're ready, deploy them <Anchor href="https://github.com/tobysmith568/license-cop/blob/b65221df595fc70d25f307047b3bc34a58b724bd/.github/workflows/website.yml#L110" text="like this" />:
